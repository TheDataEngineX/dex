...
Auto-generated API documentation for the `dataenginex` package.

| Module | Description |
|--------|-------------|
| [api](api.md) | FastAPI components — auth, health, errors, pagination, rate limiting |
| [core](core.md) | Schemas, validators, medallion architecture, pipeline config |
