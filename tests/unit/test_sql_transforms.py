...
class TestFilterTransform(TransformConformanceTests):
    ...
    def test_filter_removes_rows(self, duckdb_conn) -> None:
        duckdb_conn.execute(
...
class TestDeriveTransform(TransformConformanceTests):
    ...
    def test_derive_adds_column(self, duckdb_conn) -> None:
...
class TestCastTransform(TransformConformanceTests):
    ...
    def test_cast_changes_type(self, duckdb_conn) -> None:
...
class TestDeduplicateTransform(TransformConformanceTests):
    ...
    def test_dedup_removes_duplicates(self, duckdb_conn) -> None:
        duckdb_conn.execute(
    ...
    def test_dedup_with_multiple_keys(self, duckdb_conn) -> None:
        duckdb_conn.execute(
